namespace MusicStore.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MusicStore.DataAccessLayer.MusicContext>
    {
        ...
        protected override void Seed(MusicStore.DataAccessLayer.MusicContext context)
        {
            ...
            //foreach (var c in composersList)
            //{
            //    context.Composers.AddOrUpdate(c);
            //}
            //context.SaveChanges();
            ...
            //foreach (var r in recordLabelsList)
            //{
            //    context.Labels.AddOrUpdate(r);
            //}
            //context.SaveChanges();
            ...
            //foreach (var p in performersList)
            //{
            //    context.Performers.AddOrUpdate(p);
            //}
            //context.SaveChanges();
            ...
            //foreach (var r in recordingsList)
            //{
            //    context.Recordings.AddOrUpdate(r);
            //}
            //context.SaveChanges();
